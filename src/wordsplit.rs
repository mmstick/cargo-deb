...
fn test_split_by_chars() {
    ...
    assert_eq!(
        ...
        vec![S("This is a"), S("test"), S("string for"), S("split_by_chars.")]
    );
    ...
    assert_eq!("  trailing space    ".split_by_chars(12), vec![S("  trailing"), S("space    "),]);

    assert_eq!("  trailing space    ".split_by_chars(16), vec![S("  trailing space"), S("."),]);

    assert_eq!(
        "sh\nverylongwordverylongwordverylongwordverylongword\nend".split_by_chars(5),
        vec![S("sh"), S("verylongwordverylongwordverylongwordverylongword"), S("end"),]
    );
    ...
    assert_eq!(
        ...
        vec![S("    tabs"), S("are "), S("replaced"), S("with"), S("spaces  "),]
    );
}
